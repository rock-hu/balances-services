package com.openbanking.balances.controller;

import com.openbanking.balances.model.OBReadBalance1;
...
@Tag(name = "balances", description = "balances")
@RequestMapping(value = "")
public interface BalancesApi {

	@Operation(summary = "Get Balances", operationId = "getBalances", description = "", tags = { "Balances", })

	@RequestMapping(
			value = "/balances",
			produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" },
			method = RequestMethod.GET)
	default ResponseEntity<OBReadBalance1> getBalances(@Parameter(name = "An Authorisation Token as per https://tools.ietf.org/html/rfc6750", required = true)
