...
public interface AccountsApi {
	...
	@Operation(summary = "Get Balances", operationId = "getAccountsAccountIdBalances", description = "", tags = { "Balances", })

	@RequestMapping(
			value = "/accounts/{AccountId}/balances",
			produces = { "application/json; charset=utf-8", "application/json", "application/jose+jwe" },
			method = RequestMethod.GET)
	default ResponseEntity<OBReadBalance1> getAccountsAccountIdBalances(@Parameter(name = "AccountId", required = true)
