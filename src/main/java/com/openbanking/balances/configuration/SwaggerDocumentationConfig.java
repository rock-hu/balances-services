package com.openbanking.balances.configuration;
...
public class SwaggerDocumentationConfig {
	...
	Artifact artifact) {
		return GroupedOpenApi.builder().group("balances-services").addOpenApiCustomizer(openApi -> openApi

				.info(new Info().title(StringUtils.join(new String[] { artifact.getGroupId(), artifact.getArtifactId(), artifact.getVersion() }, ":"))
						.version(artifact.getVersion())))
				.packagesToScan("com.openbanking.balances.controller").build();
	}
